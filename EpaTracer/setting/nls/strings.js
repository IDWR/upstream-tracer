...
define({
  root: ({
    ...
    searchSetting: {
      defaultUpstreamDistanceLabel: "Set default upstream distance",
      defaultUpstreamDistanceHintLabel: "Hint: Set default value for the upstream-search-distance",
      maxUpstreamDistanceLabel: "Set maximum upstream distance",
      maxUpstreamDistanceHintLabel: "Hint: Set maximum value for the upstream-search-distance",
      upstreamDistanceUnitLabel: "Upstream-search distance units",
      upstreamDistanceUnitHintLabel: "Hint: Define unit for upstream search length",
      upstreamDistanceTextboxLabel: "Upstream Distance Text Box",
      ...
      searchHeaderText: "Search for measuring location", // Shown as a label in config panel for search an address.
